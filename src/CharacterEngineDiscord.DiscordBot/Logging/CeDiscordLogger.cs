...
/// <summary>
/// Bot-side <see cref="IDiscordLogger"/>. Always publishes
/// <see cref="ReportLogToAdminChannelCommand"/> rather than calling the Discord API directly,
/// so admin notifications survive Bot disconnects via the durable command queue.
/// </summary>
